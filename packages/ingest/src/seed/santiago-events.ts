...
export const SANTIAGO_EVENTS: SeedEvent[] = [
  ...
  },
  {
    ...
    longDesc:
      'El Cerro Blanco, en la actual comuna de Recoleta, fue un tambo del Qhapaq Ñan que conectaba el norte con el centro de Chile. Era un sitio sagrado para los pueblos picunches y quechuas, asociado a rituales y observación astronómica. Hoy alberga un parque ceremonial mapuche reconocido por el Estado.',
    yearStart: 1480,
    category: 'PUEBLOS_ORIGINARIOS',
    era: 'PREHISPANICA',
    latitude: -33.4147,
  ...
  },
  {
    ...
    longDesc:
      'A pocas semanas de fundada la villa, Pedro de Valdivia instala el primer Cabildo en torno a la Plaza Mayor. Los cabildantes —regidores, alcaldes y procurador— se reunían en una casa de adobe en el costado oriente de la plaza. El Cabildo de Santiago sería el principal órgano de poder local durante toda la Colonia.',
    yearStart: 1541,
  ...
  },
  {
    ...
    longDesc:
      'La estación original de Alameda fue inaugurada en 1857 con el primer tramo a San Bernardo. La actual estructura de hierro y vidrio fue diseñada por Gustave Eiffel y construida entre 1897 y 1900. La Estación Central conectó a Santiago con Valparaíso (1863) y posteriormente con todo el sur del país (Puerto Montt en 1913). Es Monumento Nacional desde 1983.',
    yearStart: 1857,
  ...
  },
  {
    ...
    longDesc:
      'El Club de la Unión fue fundado en 1864 y ocupó varios edificios. La sede actual en la Alameda esquina Bandera, obra del arquitecto Alberto Cruz Montt, se inauguró en 1925. Su estilo neoclásico, mármol italiano y salones imponentes lo hicieron símbolo de la oligarquía. Hasta hoy mantiene su carácter de club privado masculino.',
    yearStart: 1925,
    category: 'PATRIMONIO',
    era: 'PARLAMENTARISMO',
    latitude: -33.4423,
  ...
  },
  {
    ...
    longDesc:
      'Diseñado por los arquitectos Aníbal Fuentealba, Roberto Dávila y Ricardo Müller, inspirados en el Estadio Olímpico de Berlín de 1936, el Estadio Nacional se inaugura el 3 de diciembre de 1938. Su capacidad original era de 70.000 espectadores. Fue sede de la final del Mundial 1962 y del Centenario del fútbol chileno. En 1973 se transformó tristemente en centro de detención y tortura.',
    yearStart: 1938,
  ...
  },
  {
    ...
    longDesc:
      'El Mercado Tirso de Molina, en la ribera norte del Mapocho frente al Mercado Central, comenzó como ferias informales a fines del siglo XIX. Su pabellón actual data de 1968. Es uno de los mercados populares más característicos de Santiago, con productos frescos y cocinerías peruanas y populares. Conserva su carácter callejero pese a la modernización del entorno.',
    yearStart: 1968,
    category: 'CULTURA',
    era: 'PRESIDENCIALISMO',
    latitude: -33.4348,
  ...
  },
  {
    ...
    longDesc:
      'Diseñada por el arquitecto Ricardo Larraín Bravo inspirado en la basílica del Sacré-Cœur de Montmartre, la Iglesia del Sagrado Corazón se construyó entre 1919 y 1931 en el barrio Madrid. Sus tres cúpulas y su frontis bizantino-románico la hacen uno de los templos más singulares del país. Es Monumento Histórico.',
    yearStart: 1931,
    category: 'RELIGION',
    era: 'PRESIDENCIALISMO',
    latitude: -33.4514,
