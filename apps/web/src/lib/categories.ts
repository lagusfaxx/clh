...
export const CATEGORY_META = {
  BATALLA: { label: 'Batalla', icon: '⚔️', color: '#8B3A1F' },
  FUNDACION: { label: 'Fundación', icon: '🏛️', color: '#C9A75C' },
  DESASTRE_NATURAL: { label: 'Desastre natural', icon: '🌋', color: '#A04E2A' },
  PATRIMONIO: { label: 'Patrimonio', icon: '🏛', color: '#C9A75C' },
  PUEBLOS_ORIGINARIOS: { label: 'Pueblos originarios', icon: '🪶', color: '#7B6038' },
  POLITICA: { label: 'Política', icon: '⚖️', color: '#2C4A5C' },
  CULTURA: { label: 'Cultura', icon: '📜', color: '#9C7B3F' },
  ECONOMIA: { label: 'Economía', icon: '⚖', color: '#5C7148' },
  RELIGION: { label: 'Religión', icon: '✝', color: '#6B5840' },
  TRANSPORTE: { label: 'Transporte', icon: '🚂', color: '#4A5868' },
  CIENCIA: { label: 'Ciencia', icon: '🔬', color: '#3F6B7B' },
} as const
